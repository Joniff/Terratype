        ...
        init: function (id, urlRoot, model, config, view, updateView) {
            var scope = {
                ...
                init: function () {
                    ...
                    return {
                        files: {
                            logo: urlRoot + 'images/Logo.png',
                            mapExample: urlRoot + 'images/Example.png',
                            views: {
                                config: {
                                    definition: urlRoot + 'views/config.definition.html',
                                    apperance: urlRoot + 'views/config.apperance.html',
                                    search: urlRoot + 'views/config.search.html'
                                },
                                editor: {
                                    apperance: urlRoot + 'views/editor.apperance.html'
                                }
                            }
                        },
