        ...
        $scope.main = {
            ...
            setProvider: function (id) {
                ...
                $scope.view().loadProvider(id, function () {
                    ...
                    $scope.view().providers[index].events = $scope.view().providers[index].init($scope.view().identifier, $scope.view().providers[index].urlRoot, $scope.store, $scope.config, $scope.view, function () {
                        $scope.$apply();
                    });
