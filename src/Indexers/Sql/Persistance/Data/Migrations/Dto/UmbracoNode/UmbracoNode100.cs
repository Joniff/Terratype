...
//	This is a copy of Umbraco.Core\Models\Rdbms\NodeDto.cs in Umbraco src that is internal

namespace Terratype.Indexers.Sql.Persistance.Data.Migrations.Dto.UmbracoNode
{
    [TableName("umbracoNode")]
    [PrimaryKey("id")]
    [ExplicitColumns]
	internal class UmbracoNode100
	{
        ...
        [Column("parentID")]
        [ForeignKey(typeof(UmbracoNode100))]
