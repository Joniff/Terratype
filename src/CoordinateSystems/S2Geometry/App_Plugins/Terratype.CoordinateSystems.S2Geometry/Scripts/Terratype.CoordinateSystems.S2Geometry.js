(function (root) {
	...
	*/
	...
	var q = {
		_level: 24,		//	S2 level
		id: 'Terratype.CoordinateSystems.S2',
		toWgs: function (datum) {
			var position = S2.S2Cell.FromHilbertQuadKey(datum).getCornerLatLngs();
			return {
				latitude: position.lat,
				longitude: position.lng
			};
		},
		fromWgs: function (lat, lng) {
			return S2.latLngToKey(lat, lng, q._level);
		}
	}

	if (root.terratype && root.terratype._addCoordinateSystem) {
		root.terratype._addCoordinateSystem(q.id, q);
	} else {
