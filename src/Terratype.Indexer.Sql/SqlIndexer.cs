...
using Terratype.Indexer.Sql.Persistance.Context;
using Umbraco.Core.Logging;

namespace Terratype.Indexer
{
	public class SqlIndexer : Index, IAncestorSearch<AncestorSearchRequest>
    {
        public override string Id => "Terratype.Indexer.Sql";
