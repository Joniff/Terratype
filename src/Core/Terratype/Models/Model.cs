...
namespace Terratype.Models
{
	...
	public class Model
	{
		...
		public CoordinateDisplay CoordinateDisplay { get; internal set; }
		...
		public IEnumerable<ColorFilter> ColorFilters { get; set; }
		...
		public IHtmlString Render()
		{
			...
			using (var writer = new HtmlTextWriter(builder))
			{
				...
				Provider.Render(Guid.Empty, writer, Counter, this, labelId);
				if (Label != null)
				{
					...
					writer.RenderBeginTag(HtmlTextWriterTag.Div);
					Label.Render(Guid.Empty, writer, this);
