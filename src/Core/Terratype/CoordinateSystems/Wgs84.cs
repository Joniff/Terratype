...
namespace Terratype.CoordinateSystems
{
	...
	public class Wgs84 : PositionBase
	{
		public const string _Id = "WGS84";
		...
		{
			if (_inheritedDatum is LatLng)
			{
				return _inheritedDatum as LatLng;
			}
		...
		public Wgs84(LatLng wgs84Position)
		{
