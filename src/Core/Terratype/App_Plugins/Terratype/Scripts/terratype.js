	...
	if (!root.terratype) {
		root.terratype = {
			...
			},
			{
				...
				name: 'Orange Umbraco',
				url: function () {
					return Umbraco.Sys.ServerVariables.umbracoSettings.appPluginsPath + '/Terratype/Images/logo_orange.png';
				},
				shadowUrl: '',
				size: {
					width: 32,
			...
			},
			{
				...
				name: 'Black Umbraco',
				url: function () {
					return Umbraco.Sys.ServerVariables.umbracoSettings.appPluginsPath + '/Terratype/Images/logo_black.png';
				},
				shadowUrl: '',
				size: {
					width: 32,
			...
			{
				id: 'turquoiseumbraco',
				name: 'Turquoise Umbraco',
				url: function () {
					return Umbraco.Sys.ServerVariables.umbracoSettings.appPluginsPath + '/Terratype/Images/logo_turquoise.png';
				},
				shadowUrl: '',
				size: {
					width: 30,
			...
			},
			{
				...
				name: 'White Umbraco',
				url: function () {
					return Umbraco.Sys.ServerVariables.umbracoSettings.appPluginsPath + '/Terratype/Images/logo_white.png';
				},
				shadowUrl: '',
				size: {
					width: 32,
	...
	angular.module('umbraco').controller('terratype', ['$scope', '$timeout', '$http', 'localizationService', 
		...
		$scope.terratype = {
			...
			setLabel: function (id) {
				...
				if ($scope.vm().provider.events.labelChange) {
		...
		$scope.init = function () {
			...
			$scope.rte = {
				...
				createLabel: function (editor) {
					...
					root.tinymce.DOM.add(el, 'span', { style: { 'padding': '10px', 'color': '#aaaaaa', 'font-size': '17px !important;', 'white-space': 'pre-wrap', 'display': 'inline-block' } }, text)
