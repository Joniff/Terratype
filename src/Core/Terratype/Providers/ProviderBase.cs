...
namespace Terratype.Providers
{
	...
	public abstract class ProviderBase : DiscoverBase, IProvider
	{
		/// <summary>
		...
		public abstract void Render(Guid key, HtmlTextWriter writer, int id, IMap model, string labelId = null, int? height = null, string language = null, 
