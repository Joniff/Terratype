...
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(Terratype.Test.Umbraco772.AutoLoginModule), "Register")]
namespace Terratype.Test.Umbraco772
{
	public class AutoLoginModule : IHttpModule
	{
		...
		private void Application_EndRequest(object source, EventArgs e)
		{
			...
			if (uri.Equals("umbraco/AuthorizeUpgrade", StringComparison.InvariantCultureIgnoreCase))
			{
				...
				//var userId = userService.GetByUsername("steve@gibedigital.com");
